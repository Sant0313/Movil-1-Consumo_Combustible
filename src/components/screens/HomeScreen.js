    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.headerContainer}>
                ...
                <TouchableOpacity style={styles.profileBtn} onPress={() => navigation.navigate('User')}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.gridContainer}>
                    <TouchableOpacity style={styles.gridItem} onPress={() => navigation.navigate('Fuel')}>
                    ...
                    <TouchableOpacity style={styles.gridItem} onPress={() => navigation.navigate('Reports')}>
                        <View style={[styles.iconContainer, { backgroundColor: 'rgba(184, 181, 28, 0.15)' }]}>
                            <Ionicons name="bar-chart" size={28} color={colors.variante3} />
                        </View>
                        <Text style={styles.gridText}>Reportes</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={styles.gridItem} onPress={() => navigation.navigate('Feature', { title: 'Taller', iconName: 'build', color: colors.variante3 })}>
                        <View style={[styles.iconContainer, { backgroundColor: 'rgba(184, 181, 28, 0.15)' }]}>
                ...
                <View style={styles.activityHeader}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Feature', { title: 'Actividad', iconName: 'list', color: colors.dark })}>
